...
facts = [
    ...
    "Hawaiian is a Polynesian language with only 13 letters in its alphabet.",
    "Arabic is written from right to left, unlike most other languages.",
    "Icelandic has remained relatively unchanged for over 1,000 years, allowing modern Icelanders to read ancient texts with ease.",
    "Esperanto is the most widely spoken constructed language, created in the late 19th century to foster international communication.",
    "Sanskrit is one of the oldest languages in the world and is considered the liturgical language of Hinduism.",
    "The Rosetta Stone was key in deciphering Egyptian hieroglyphs, as it contained the same text in three different scripts: Greek, Demotic, and hieroglyphic.",
    "Latin is often called a 'dead language' because it no longer has native speakers, but it remains influential in science, law, and the Roman Catholic Church.",
    "Pidgin languages develop as simplified means of communication between groups that do not share a common language, often in trade or colonial contexts.",
    "The word 'alphabet' can also refer to any set of letters used in a specific language, such as the Cyrillic alphabet used in Russian.",
    "Zulu, a language spoken in South Africa, has three types of click consonants.",
    "Morse code is a language of dots and dashes used historically in telecommunication, representing letters and numbers.",
    "The Navajo language was used as a code by the United States during World War II, as it was difficult for the enemy to decipher.",
    "Linguistic relativity suggests that the structure of a language influences how its speakers perceive and think about the world.",
    "A palindrome is a word, phrase, or sequence that reads the same backward as forward, like 'madam' or 'racecar'.",
    "Hindi and Urdu are mutually intelligible when spoken but have different scripts; Hindi uses Devanagari, while Urdu uses a Persian-Arabic script.",
    "Sign languages can differ significantly from one another, just like spoken languages; for instance, American Sign Language (ASL) is quite different from British Sign Language (BSL).",
    "Greek has been spoken for over 3,000 years, making it one of the oldest recorded living languages.",
    "Welsh is experiencing a revival, with efforts in Wales to increase the number of Welsh speakers through education and media.",
    "Tamil is one of the longest-surviving classical languages in the world, with a history that dates back more than 2,000 years.",
    "The Whistled Language of La Gomera in the Canary Islands, called Silbo Gomero, uses whistling to convey messages across long distances.",
    "Luxembourgish is the national language of Luxembourg and has official status alongside French and German."
]
